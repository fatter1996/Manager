...
#include <QDir>
#include <QDebug>
ConfigInfoV* GlobalDataV::m_pConfigInfo = nullptr;

void ConfigInfoV::init()
{
    QString path = QDir::currentPath() + "/data/VideoConfig.ini";
    qDebug() << path;
...
int GlobalDataV::getBigEndian_2Bit(QByteArray bigArray)
{
...
QDateTime GlobalDataV::getDateTimeByArray(QByteArray data)
{
    QDateTime dateTime;
...
bool GlobalDataV::IsSessionLocked()
{
